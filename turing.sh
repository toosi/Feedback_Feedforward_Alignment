...
# python -u create_configr.py  -dataset CIFAR10    -j 24 --input_size 32 --base_channels 64 --batch-size 256 --epoch 400 -ae asymresnet18 -ad asymresnetT18 --optimizerF 'SGD' --optimizerB 'SGD' --lrF 1e-2 --lrB 1e-2 --wdF 1e-4 --wdB 1e-4 --patiencee 30 --patienced 20 -p 100 --note  $note ; config=1  #
...
if [ $config == 0 ]
  then
    runname=Oct21-15-31_CIFAR10_2d7b663bb6_788 # Oct21-14-16_CIFAR10_2d7b663bb6_96  #Oct21-13-52_CIFAR10_2d7b663bb6_905 
