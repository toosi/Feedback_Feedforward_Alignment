# written by:https://github.com/kharvd/cifar-10.1-pytorch/blob/master/cifar10_1.py
...
#     #'https://github.com/modestyachts/CIFAR-10.1/blob/master/datasets/cifar10.1-data.npy?raw=true'
#     images_md5 = '29615bb88ff99bca6b147cee2520f010' #'29615bb88ff99bca6b147cee2520f010'
#     images_filename = 'cifar10.1_v4_data.npy' # 'cifar10.1-data.npy'

#     labels_url = 'https://github.com/modestyachts/CIFAR-10.1/blob/master/datasets/cifar10.1_v6_labels.npy?raw=true'
#     #'https://github.com/modestyachts/CIFAR-10.1/blob/master/datasets/cifar10.1-labels.npy?raw=true'
#     labels_md5 = 'a27460fa134ae91e4a5cb7e6be8d269e' #'a27460fa134ae91e4a5cb7e6be8d269e'
#     labels_filename = 'cifar10.1_v4_label.npy' # 'cifar10.1-labels.npy'
    ...
    def _check_integrity(self):
        ...
        print(labels_path)
        return True                #(check_integrity(data_path, self.images_md5) and 
