...
# Convolutional
python -u create_config.py --hash RMSpRMSpMNISTAsymResLNet10BNaffine2 -dataset MNIST  -j 24 --input_size 32 --base_channels 64 --batch-size 512 --epoch 200 -ae AsymResLNet10F -ad AsymResLNet10B --optimizerF 'RMSprop' --optimizerB 'RMSprop' --lrF 1e-3 --lrB 1e-3 --wdF 1e-5 --wdB 1e-6 --patiencee 50 --patienced 40 -p 100 --note  $note ; config=1  #
