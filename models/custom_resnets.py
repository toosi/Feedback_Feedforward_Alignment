...
# from modules import customized_modules_layerwise as customized_modules  # !!! dont forget to add primitive_weights (=[0,0,0]) to modules
try:
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.bn1 = norm_layer(planes, affine=False, track_running_stats=False) # downsampling
...
class BasicBlockT(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, upsample=None, groups=1,
        ...
        self.bn1 = norm_layer(inplanes, affine=False, track_running_stats=False)#upsampling
        self.relu = nn.ReLU(inplace=False)
